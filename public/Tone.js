;(function(root, factory) {
  ...
  Module(function(Tone) {
    ...
    Tone.Timeline.prototype._iterate = function(
      ...
      this._timeline.slice(lowerBound, upperBound + 1).forEach(
        function(event) {
  ...
  Module(function(Tone) {
    ...
    Tone.TimeBase = function(val, units) {
      ...
      if (this instanceof Tone.TimeBase) {
        ...
        if (
          Tone.isUndef(this._units) &&
          Tone.isString(this._val) && // eslint-disable-next-line eqeqeq
  ...
  Module(function(Tone) {
    ...
    Tone.Frequency.prototype.transpose = function(interval) {
      return new this.constructor(
        this.valueOf() * Tone.intervalToFrequencyRatio(interval)
      )
    }
    /**
  ...
  Module(function(Tone) {
    ...
    Tone.Time.prototype.toNotation = function() {
      ...
      testNotations.forEach(function(notation) {
        ...
        if (
          Math.abs(notationSeconds - time) < Math.abs(closestSeconds - time)
        ) {
          closest = notation
  ...
  Module(function(Tone) {
    ...
    Object.defineProperty(Tone.Param.prototype, 'minValue', {
      get: function() {
        if (
          this.units === Tone.Type.Time ||
          this.units === Tone.Type.Frequency ||
          this.units === Tone.Type.NormalRange ||
          this.units === Tone.Type.Positive ||
    ...
    Tone.Param.prototype.getValueAtTime = function(time) {
      ...
      var initialValue = Tone.defaultArg(
        this._initialValue,
  ...
  Module(function(Tone) {
    ...
    Tone.TickSignal.prototype.setValueAtTime = _wrapScheduleMethods(
      Tone.Signal.prototype.setValueAtTime
    )
    Tone.TickSignal.prototype.linearRampToValueAtTime = _wrapScheduleMethods(
      Tone.Signal.prototype.linearRampToValueAtTime
    )
    /**
     *  Start exponentially approaching the target value at the given time with
     *  a rate having the given time constant.
    ...
    Tone.TickSignal.prototype._getTicksUntilEvent = function(event, time) {
      ...
      if (
        this._events.get(time).time === time &&
        this._events.get(time).type === Tone.Param.AutomationType.SetValue
      ) {
  ...
  Module(function(Tone) {
    ...
    Tone.TickSource.prototype.getTicksAtTime = function(time) {
      ...
      this._state.forEachBetween(
        ...
        function(e) {
          ...
          if (
            lastState.state === Tone.State.Started &&
            e.state !== Tone.State.Started
          ) {
            elapsedTicks +=
    ...
    Tone.TickSource.prototype.forEachTickBetween = function(
      ...
      this._state.forEachBetween(
        ...
        function(event) {
          if (
            lastStateEvent.state === Tone.State.Started &&
            event.state !== Tone.State.Started
          ) {
  ...
  Module(function(Tone) {
    ...
    Tone.Source.prototype.sync = function() {
      ...
      this._syncedStop = function(time) {
        var seconds = Tone.Transport.getSecondsAtTime(
  ...
  Module(function(Tone) {
    ...
    Tone.BufferSource.prototype.start = function(
      ...
      var computedDur = this.toSeconds(
        Tone.defaultArg(
          duration,
          this.buffer.duration - offset % this.buffer.duration
        )
      )
    ...
    Tone.BufferSource.prototype.cancelStop = function() {
      if (this._startTime !== -1 && !this._sourceStopped) {
        ...
        this._gainNode.gain.cancelScheduledValues(
          this._startTime + fadeInTime + this.sampleTime
        )
        this._gainNode.gain.setValueAtTime(
          1,
          Math.max(this.now(), this._startTime + fadeInTime + this.sampleTime)
        )
  ...
  Module(function(Tone) {
    ...
    Tone.Event.prototype._tick = function(time) {
      ...
      if (
        !this.mute &&
        this._state.getValueAtTime(ticks) === Tone.State.Started
      ) {
    ...
    Tone.Part.prototype.remove = function(time, value) {
      ...
      for (var i = this._events.length - 1; i >= 0; i--) {
        ...
        if (event instanceof Tone.Part) {
          ...
          if (
            Tone.isUndef(value) ||
            (Tone.isDefined(value) && event.value === value)
          ) {
  ...
  Module(function(Tone) {
    ...
    Tone.Instrument.prototype._syncMethod = function(method, timePosition) {
      ...
      this[method] = function() {
        ...
        var id = Tone.Transport.schedule(
          function(t) {
            args[timePosition] = t
  ...
  Module(function(Tone) {
    ...
    Tone.DuoSynth.prototype.getLevelAtTime = function(time) {
      return (
        (this.voice0.getLevelAtTime(time) + this.voice1.getLevelAtTime(time)) /
        2
      )
    }
    /**
  ...
  Module(function(Tone) {
    ...
    Tone.TransportTimelineSignal.prototype.setTargetAtTime = function(
      ...
      Tone.Signal.prototype.setTargetAtTime.call(
        this,
        value,
        startTime,
        timeConstant
    ...
    Tone.TransportTimelineSignal.prototype.setValueCurveAtTime = function(
      ...
      Tone.Signal.prototype.setValueCurveAtTime.call(
        this,
        values,
        startTime,
        duration,
    ...
    Tone.TransportTimelineSignal.prototype.cancelAndHoldAtTime = function(
      ...
      return Tone.Signal.prototype.cancelAndHoldAtTime.call(
        this,
  ...
  Module(function(Tone) {
    ...
    Tone.Player.prototype._start = function(startTime, offset, duration) {
      ...
      offset = this.toSeconds(offset)
      var computedDuration = Tone.defaultArg(
        duration,
      ...
      if (!this._loop && !this._synced) {
        ...
        this._state.setStateAtTime(
          Tone.State.Stopped,
          startTime + computedDuration / this._playbackRate
        )
      }
    ...
    Tone.Player.prototype._stopAtNextIteration = function(now) {
      if (this._state.getValueAtTime(now) === Tone.State.Started) {
        ...
        var stopTime = this._elapsedTime.getTimeOfTick(
          iterations * this.buffer.duration,
          nextStop ? nextStop.time - this.sampleTime : Infinity
        )
        this.stop(stopTime)
      }
    }
    ...
    Object.defineProperty(Tone.Player.prototype, 'position', {
      get: function() {
        var now = this.now()
        if (
          this._state.getValueAtTime(now) === Tone.State.Started &&
          this.loaded
        ) {
  ...
  Module(function(Tone) {
    ...
    Object.defineProperty(Tone.UserMedia, 'supported', {
      get: function() {
        return (
          Tone.isDefined(navigator.mediaDevices) &&
  ...
  Module(function(Tone) {
    ...
    Tone.Midi.prototype._frequencyToUnits = function(freq) {
      return Tone.Frequency.ftom(
        Tone.Frequency.prototype._frequencyToUnits.call(this, freq)
      )
    }
    /**
     *  Returns the value of a tick in the current time units
    ...
    Tone.Midi.prototype._ticksToUnits = function(ticks) {
      return Tone.Frequency.ftom(
        Tone.Frequency.prototype._ticksToUnits.call(this, ticks)
      )
    }
    /**
     *  Return the value of the beats in the current units
    ...
    Tone.Midi.prototype._beatsToUnits = function(beats) {
      return Tone.Frequency.ftom(
        Tone.Frequency.prototype._beatsToUnits.call(this, beats)
      )
    }
    /**
     *  Returns the value of a second in the current units
    ...
    Tone.Midi.prototype._secondsToUnits = function(seconds) {
      return Tone.Frequency.ftom(
        Tone.Frequency.prototype._secondsToUnits.call(this, seconds)
      )
    }
    /**
     *  Return the value of the frequency as a MIDI note
